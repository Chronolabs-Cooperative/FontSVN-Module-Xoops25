...
define('_MB_FONTSVN_NUMBER','Number of Items:');
define('_MB_FONTSVN_DISPLAY','Display Method:');
define('_MB_FONTSVN_NAMING','Naming Image');
define('_MB_FONTSVN_TEXT','Textual Context');
define('_MB_FONTSVN_FONT_NAME', 'Font Name');
define('_MB_FONTSVN_FONT_VIEWS', 'Font Views');
define('_MB_FONTSVN_FONT_DOWNLOADS', 'Font Downloads');